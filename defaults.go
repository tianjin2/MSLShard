...
const default_vCPUs uint = 2      //16
const default_instances uint = 10 //8
const default_n uint = 10        // 128
const default_m uint = 2          // number of comimttees
const default_totalF uint = 1     //3
const default_committeeF uint = 1 //2

// const default_d uint = 8
const default_nUsers uint = default_n * 20
const default_totalCoins uint = default_nUsers * 40
